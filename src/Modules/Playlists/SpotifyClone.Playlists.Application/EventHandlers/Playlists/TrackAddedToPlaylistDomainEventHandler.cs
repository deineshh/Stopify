...
internal sealed class TrackAddedToPlaylistDomainEventHandler(
    IPlaylistsUnitOfWork unit)
    : INotificationHandler<TrackAddedToPlaylistDomainEvent>
{
    private readonly IPlaylistsUnitOfWork _unit = unit;

    public async Task Handle(
        TrackAddedToPlaylistDomainEvent notification,
        CancellationToken cancellationToken)
    {
        var integrationEvent = new TrackAddedToPlaylistIntegrationEvent(
