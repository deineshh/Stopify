...
internal sealed class TrackTitleChangedIntegrationEventHandler(
    ISearchIndexer searchIndexer,
    ISearchProvider searchProvider)
    : INotificationHandler<TrackTitleChangedIntegrationEvent>
{
    ...
    public async Task Handle(
        TrackTitleChangedIntegrationEvent notification,
