...
internal sealed class PlaylistGeneratedCoverUpdatedIntegrationEventHandler(
    ISearchIndexer searchIndexer,
    ISearchProvider searchProvider)
    : INotificationHandler<PlaylistGeneratedCoverUpdatedIntegrationEvent>
{
    ...
    public async Task Handle(
        PlaylistGeneratedCoverUpdatedIntegrationEvent notification,
