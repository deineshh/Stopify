...
internal sealed class UserProfileUnlinkedFromAvatarImageDomainEventHandler(
    IAccountsUnitOfWork unit)
    : INotificationHandler<UserProfileUnlinkedFromAvatarImageDomainEvent>
{
    private readonly IAccountsUnitOfWork _unit = unit;

    public async Task Handle(
        UserProfileUnlinkedFromAvatarImageDomainEvent notification,
